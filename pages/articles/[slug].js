...
// Impor ini disimulasikan sebagai data lokal untuk lingkungan Single-File
// Dalam proyek Next.js nyata, ini akan diimpor dari '../../data/articles'

// DUMMY DATA ARTICLES - Data ini mensimulasikan konten dari '../../data/articles'
const articles = [
  {
    slug: 'panduan-pull-request',
    title: 'Panduan Praktis Kontribusi Proyek Open Source Web3 Melalui PR', 
    author: 'Gemini Dev',
    date: '2025-10-04',
    content: `
...
<p>Ini adalah alur kerja yang aman dan efisien untuk kolaborasi di ranah Web3.</p>
  ...
  },
  {
    ...
    title: 'Mengapa Next.js SSG Ideal untuk Dokumentasi dApp & Blog Crypto?', 
...
<p>Inilah alasan kami memilih Next.js sebagai fondasi untuk menyampaikan informasi *crypto* secara cepat dan aman.</p>
  ...
  },
  {
    ...
    title: 'Tips Cepat Menulis Konten Edukasi Web3 yang Jelas dengan Markdown', 
